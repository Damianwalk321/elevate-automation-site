(() => {
  ...
  const MODULES = [
    ...
    "/dashboard-section-governor.js?v=20260513sg1",
    ...
    "/dashboard-tools.js?v=20260513sg2",
    "/dashboard-execution-hub-p3.js?v=20260513sg3",
    "/dashboard-execution-hub-cleanup.js?v=20260513sg4",
    "/dashboard-execution-hub-hard-replace.js?v=20260513sg5",
