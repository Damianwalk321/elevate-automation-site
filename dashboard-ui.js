(() => {
  ...
  function sidebarNavMeta() {
    return {
      ...
      tools: { label: "Tools", detail: "Posting, queue, extension", icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14.7 6.3a4.5 4.5 0 0 0-5.96 5.96L4 17l3 3 4.74-4.74a4.5 4.5 0 0 0 5.96-5.96l-2.02 2.02-3-3z"></path></svg>` },
      analytics: { label: "Analytics", detail: "Listings, review, performance", icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 19.5h16"></path><path d="M7 16V9"></path><path d="M12 16V5"></path><path d="M17 16v-4"></path></svg>` },
