...
(() => {
  ...
  NS.version = "bundle2-core-runtime-intelligence-review-cleanup-20260513b";
  ...
  const MODULES = [
    ...
    "/dashboard-listings.js?v=20260513review3",
    "/dashboard-profile.js?v=20260406p12a",
    "/dashboard-analytics.js?v=20260513reviewShell1",
